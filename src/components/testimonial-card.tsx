...
export function TestimonialCard({ testimonial }: TestimonialCardProps) {
  return (
    <div className="w-full max-w-sm md:max-w-md lg:max-w-lg min-h-[220px] flex-shrink-0 p-5 rounded-xl border border-gray-200 bg-white flex flex-col justify-between shadow-sm">
      ...
      <p className="md:text-xs text-[#374151] text-left flex-grow leading-relaxed">{testimonial.text}</p>
      ...
      <div className="flex items-center gap-3 mt-4">
        ...
        <div className="flex flex-col">
          <span className="text-sm md:text-base text-[#1e1e1e] font-medium text-left">{testimonial.authorName}</span>
